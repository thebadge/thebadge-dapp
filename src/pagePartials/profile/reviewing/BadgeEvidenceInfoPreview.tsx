...
export default function BadgeReviewingInfoPreview({ badge }: { badge: Badge }) {
  ...
  return (
    <Stack gap={4} p={1}>
      ...
      <Alert severity="info">
        {isRegistration
          ? t('profile.normal.badgesIAmReviewing.submissionChallenge')
          : t('profile.normal.badgesIAmReviewing.removalChallenge')}
      </Alert>
      ...
      <Box display="flex" flex="1" justifyContent="space-between">
        ...
        >
          {t('profile.normal.badgesIAmReviewing.viewAll')}
        </ButtonV2>
        <ButtonV2
          backgroundColor={colors.transparent}
          fontColor={colors.white}
          ...
          variant="outlined"
        >
          {t('profile.normal.badgesIAmReviewing.addEvidence')}
        </ButtonV2>
      </Box>
