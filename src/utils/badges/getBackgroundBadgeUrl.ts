...
export function getBackgroundBadgeUrl(backgroundName?: string | number) {
  if (backgroundName) {
    return BADGE_MODEL_BACKGROUNDS[backgroundName] || BADGE_MODEL_BACKGROUNDS['White Waves']
  }
  return BADGE_MODEL_BACKGROUNDS['White Waves']
}
