...
const gradientLight = 'linear-gradient(180deg, rgba(137, 28, 251, 0.2475) -13.61%, rgba(255, 255, 255, 0.254) 40.93%, rgba(255, 255, 255, 0.55) 82.02%, rgba(255, 255, 255, 0.75) 129.84%)'
...
declare module '@mui/material/styles' {
  interface Palette extends TBPaletteExtensions {}
  interface PaletteOptions extends TBPaletteExtensions {}
}
