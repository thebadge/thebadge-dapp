...
export const contracts = {
  TheBadge: {
    address: {
      [Chains.goerli]: '0x8948cc0dcf830a345891d68d504fbfdeed9cd4ee',
  ...
  TheBadgeUsers: {
    address: {
      [Chains.goerli]: '0x8cf210dc04137f645dd19b029d82ef7626640303',
  ...
  TheBadgeModels: {
    address: {
      [Chains.goerli]: '0x5ea8745702cb89d78bd9658D95F2B7Cc674DCa2E',
